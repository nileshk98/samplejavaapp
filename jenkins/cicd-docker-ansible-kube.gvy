    ...
    stage('build & push docker image') {
	   steps {
              withDockerRegistry(credentialsId: 'DOCKER_HUB_LOGIN', url: 'https://index.docker.io/v1/') {
                    ...
                    sh script: 'docker build --file Dockerfile --tag docker.io/kapania98/dockerdemo:$BUILD_NUMBER .'
                    sh script: 'docker push docker.io/kapania98/dockerdemo:$BUILD_NUMBER'
              }	
           }		
    }
    stage('Deploy-QA') {
